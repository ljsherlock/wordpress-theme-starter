...
class People extends CustomPost
{
  protected $name = "staff";
  protected $singular = "Person";
  protected $plural = "People";
  protected $icon = 'dashicons-groups';

  public function __construct()
  {
    // \Routes::map('staff/page/:paged', function($params){
    //   $people = new \Controllers\People(array( 'query' => array('paged' => $params['paged'] )));
